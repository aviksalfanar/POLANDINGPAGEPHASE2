		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PO Landing Page",
									"targetURL": "#comalfanarpolandingpagepolandingpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comalfanarpolandingpagepolandingpage-display": {
								"semanticObject": "comalfanarpolandingpagepolandingpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.alfanar.polandingpage.polandingpage",
									"url": sap.ui.require.toUrl("com/alfanar/polandingpage/polandingpage")
								}
							}
						}
					}
